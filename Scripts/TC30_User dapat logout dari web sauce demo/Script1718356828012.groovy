...
// 27. Verify Order Confirmation Page is Displayed
WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/Verif_TerimaKasih'), 'Thank you for your order!')
TestObject thanksObject = findTestObject('Object Repository/Page_Swag Labs/Verif_TerimaKasih')
String jsCodethanks = 'arguments[0].style.border=\'3px solid red\''
WebUI.executeJavaScript(jsCodethanks, Arrays.asList(WebUI.findWebElement(thanksObject)))
println("Element Thanks is present and highlighted.")

// 28. Click on Back Home Button
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Back Home'))

// 29. Verify User is Redirected to Home Page
boolean homepagePresent = WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/Verif_Back_To_Halaman_Utama'), 10)
if (homepagePresent) {
	// Highlight the shopping cart badge element
	TestObject homeObject = findTestObject('Object Repository/Page_Swag Labs/Verif_Back_To_Halaman_Utama')
	String jsHighlighthome = 'arguments[0].style.border=\'3px solid red\''
	WebUI.executeJavaScript(jsHighlighthome, Arrays.asList(WebUI.findWebElement(homeObject)))
	println("Back to home page is displayed and highlighted.")
} else {
	println("Back to home page is not displayed.")
}

// 30. Logout Web
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Open Menu'))
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/Button_Logout'))
